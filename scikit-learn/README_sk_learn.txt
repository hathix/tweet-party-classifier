...
Using scikit-learn helps to cut down on development time by sparing us the troule of having to implement the internal details of every algorithm, it also provides us with a simple and flexible framework to test future approaches.
